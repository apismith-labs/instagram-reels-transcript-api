...
This phase includes the repository scaffold, documentation placeholders, and runnable cURL, Python, and Node.js examples.

Java and Go examples remain scaffold-only and will be added in later phases.
...
The cURL quick validation example is available in `examples/curl/`. Python examples are available in `examples/python/`. Node.js examples are available in `examples/nodejs/`. Java and Go examples are still scaffold-only.
